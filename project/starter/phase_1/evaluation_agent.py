...
evaluation_results = evaluation_agent.evaluate(prompt)

print("\n" + "-" * 50)
print(f"Prompt : {prompt}")
print(f"Final Answer: {evaluation_results['final_response']}")
print(f"Evaluation: {evaluation_results['evaluation']}")
print(f"Number of iterations: {evaluation_results['iterations_number']}")